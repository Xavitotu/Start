...
left = "left" and "l" and "L"
right = "right" and "r" and "R"
down = "down"
up = "up"
yes = "yes"
no = "no"
...
if a == left and b == yes:
    ...
    slowprint("")
    slowprint("Probably for the better, you don't have alot of battery after all. You continue slowly, feeling the road before you walk on it. All of the sudden you hear movement behind you in the bushes, it starts off distant but it quickly\ngets louder behind you. whatever it is it's rushing towards you in an alarming rate. Do you run? ")
    slowprint('"Write yes or no"')
    c = input("")

if a == left and b == yes and c == sleep or yes:
    slowprint("")
...
elif a == left and b == yes and c == cont or no:
    slowprint("")
